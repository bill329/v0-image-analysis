...
// ✅ SEO Metadata (this replaces <Head>)
export const metadata: Metadata = {
  title: "Custom Granite & Quartz Countertops Gallery | Stone Concepts",
  description:
    "Explore Stone Concepts’ gallery of stunning granite and quartz countertop installations across Massachusetts. See our craftsmanship in kitchens and bathrooms.",
  alternates: {
    canonical: "https://www.stoneconcepts.net/gallery",
  },
}
