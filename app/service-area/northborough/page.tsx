            ...
            <div className="flex flex-col md:flex-row items-center md:space-x-8">
              ...
              <div className="md:w-1/2 space-y-6">
                <p className="text-gray-600 leading-relaxed">
                  You've upgraded everything else. New appliances. Fresh paint.
                  Updated lighting. But every time you walk into your kitchen,
                  those countertops remind you there's still work to do.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  The laminate shows every water stain. The tile grout never
                  looks quite clean. That crack near the cooktop has been there
                  so long, you've stopped noticing it—except when guests visit
                  and you catch yourself making excuses.
                </p>

                <h3 className="font-semibold">
                  {" "}
                  What if your countertops could be the showpiece instead of the
                  apology?
                </h3>

                <p className="text-gray-600 leading-relaxed">
                  Stone Concepts transforms Northborough homes with premium
                  countertops that don't just survive daily life—they elevate
                  it. From heat-resistant granite countertops in Northborough to
                  luxurious marble countertops in Northborough to virtually
                  indestructible engineered quartz, we're the countertop
                  installers in Northborough, MA who handle everything from
                  selection through installation.
                </p>

                <p className="text-gray-600 leading-relaxed">
                  And here's why Northborough homeowners keep recommending us:
                  we've been doing this for decades. We know which stones work
                  with Colonial-style homes. We understand the layout quirks of
                  split-levels and raised ranches. We source from suppliers who
                  deliver quality, not surprises.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  When you're ready to stop apologizing for your countertops and
                  start showing them off, we're ready to help.
                </p>
              </div>
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="text-center mb-10">
              ...
              <div className="text-sm uppercase tracking-widest text-gray-600 font-medium mt-2">
                Granite isn't trendy—it's timeless. And there's a reason it's
                remained the gold standard for kitchen countertops for 30+
                years.
              </div>
              ...
              <p className="text-gray-600 leading-relaxed mt-2">
                Natural patterns that make every installation unique. Heat
                resistance that handles hot pans without panic. Durability that
                stands up to knife slips, dropped dishes, and the daily chaos of
                family life. Beauty that doesn't fade after the first year. Last
                month, we installed Absolute Black granite in a Northborough
                kitchen. The homeowner told us, "I didn't realize how much
                mental energy I was spending worrying about my old countertops
                until they were gone." That's the granite difference.
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
            ...
            <p className="text-gray-600 leading-relaxed mt-10 text-center">
              The end result? A granite surface that looks so natural in your
              kitchen, visitors assume it's always been there.
            </p>
          </div>
        </section>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center md:space-x-8">
              ...
              <div className="md:w-1/2 space-y-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Walk into a bathroom with Carrara marble, and you immediately
                  feel the difference. The soft veining. The luminous finish.
                  The unmistakable luxury that no engineered material can
                  replicate.
                </p>

                <h5 className="font-semibold">
                  Marble isn't practical for every space—but in the right
                  application, nothing compares.
                </h5>

                <p className="text-gray-600 leading-relaxed">
                  We installed marble countertops in Northborough last week for
                  a homeowner renovating a master bathroom. She'd been debating
                  between quartz and marble for months. The moment she saw the
                  Calacatta marble installed, she said, "I'm so glad I didn't
                  play it safe."
                </p>

                <p className="text-gray-600 leading-relaxed">
                  That's marble's power. It elevates a space from "nice" to
                  "stunning."
                </p>
            ...
            <div className="mt-12 px-20">
              ...
              <ul className="mt-6 list-disc list-inside text-gray-600  mb-4">
                <li className="mt-4">
                  {" "}
                  Bathroom vanities that feel like a spa retreat
                </li>
                <li className="mt-2 ">
                  {" "}
                  Decorative islands that become conversation pieces
                </li>
                <li className="mt-2 ">
                  {" "}
                  Baking stations (marble's naturally cool surface is perfect
                  for pastry work)
                </li>
                <li className="mt-2 ">
                  {" "}
                  Powder rooms where elegance matters more than durability
                </li>
              </ul>

              <h3 className="font-semibold">The Honest Truth About Marble:</h3>
              <p className="text-gray-600 leading-relaxed mt-6">
                It's softer than granite. It can etch from acidic liquids like
                lemon juice or wine. It requires periodic sealing and thoughtful
                care.
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
                But here's what marble owners tell us: "I don't regret it for a
                second."
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
                When we install marble countertops in Northborough, we treat
                them with the craftsmanship they deserve. Precise cuts. Seamless
                joins. Expert sealing. And guidance on maintenance that keeps
                your marble looking beautiful for decades.
              </p>
              <p className="text-gray-600 leading-relaxed mt-2">
                If you're seeking sophistication that makes a statement, marble
                delivers.
              </p>
            </div>
          </div>
          ...
          <div className=" sm:px-6 lg:px-8">
            <div className="grid grid-cols-1 lg:grid-cols-4 gap-12">
              <div className="lg:col-span-2">
                <h3 className="text-3xl font-bold text-white mb-4">
                  Quartz Installers Near Northborough: The Modern Performance
                  Choice
                </h3>
                <p className=" leading-relaxed">
                  Engineered quartz is what happens when you take everything
                  homeowners love about natural stone and solve all the
                  problems.
                </p>
                <ul className="mt-6 list-disc list-inside  mb-4">
                  ...
                  <li className="mt-2 ">
                    Stain-resistant? Check. (Coffee, wine, turmeric—bring it
                    on.)
                  </li>
                  <li className="mt-2 ">
                    Heat-resistant? Check. (Within reason—use a trivet for very
                    hot pans.)
                  </li>
                  <li className="mt-2 ">
                    Scratch-resistant? Check. (Cutting boards are still smart,
                    but daily use won't show wear.)
                  </li>
                  <li className="mt-2 ">
                    Consistent color and pattern? Check. (What you see in the
                    showroom is what gets installed.)
                  </li>
                </ul>
                <p className=" leading-relaxed  mb-4">
                  One Northborough family with three kids told us their quartz
                  countertops "still look exactly like installation day three
                  years later, and we're not gentle with them."
                </p>
                <p className=" leading-relaxed">
                  That's the quartz promise: premium appearance with
                  zero-maintenance performance.
                </p>
              </div>
              <div className="lg:col-span-2">
                <h3 className="text-xl font-bold  mb-4">
                  Our quartz installers near Northborough guide you through the
                  entire process:
                </h3>
                <ul className="space-y-6">
                  <li>
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p>
                          Quartz offers hundreds of options—from classic marble
                          looks to bold contemporary patterns to subtle
                          neutrals. We help you choose based on your cabinets,
                          lighting, and lifestyle, not just what looks good in
                          the showroom.
                        </p>
                      </div>
                    </div>
                  ...
                  <li>
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        <div className="text-xl font-semibold  mb-2">
                          Expert Template and Fabrication
                        </div>
                        <p>
                          We use digital templating for precision you can't
                          achieve with cardboard. Our fabricators understand how
                          engineered stone behaves differently from natural
                          stone, which matters for strength and longevity.
                        </p>
                      </div>
                    </div>
                  </li>
                  <li>
                    <div className="flex items-start space-x-4">
                      ...
                      <div className="flex-1">
                        ...
                        <p>
                          Quartz is heavy and unforgiving—there's no room for
                          error. Our installers have completed hundreds of
                          quartz projects in Northborough homes. They know how
                          to handle inside corners, undermount sinks, and
                          complex edge details without issues.
                        </p>
                      </div>
                    </div>
                  </li>
            ...
            <div className="mt-12 ">
              ...
              <p>
                ...
                requires nothing more than soap and water to maintain. It's the
                practical choice that doesn't look practical.
              </p>
            </div>
          </div>
        </section>
          ...
          <div className=" mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold text-gray-800">
                Our 3-Step Process: From Consultation to Cooking in Weeks, Not
                Months
              </h2>
              <p className="text-sm tracking-widest text-gray-600 font-medium mt-2">
                Getting new granite countertops in Northborough shouldn't mean
                living in construction chaos for half a year. We've streamlined
                everything so the process is enjoyable.
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 lg:gap-4">
              <div className="relative">
                <div className="bg-gray-100 p-8 h-full border border-gray-400 ">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    We have a phone consultation about your Northborough home
                    and how you use your space. We listen to how you actually
                    use your kitchen or bathroom.
                  </p>
                  ...
                  <p className="text-gray-600  mt-4">
                    The answers shape which stone we recommend. We take precise
                    measurements and discuss your timeline and budget openly.
                  </p>
                </div>
              </div>
              ...
              <div className="relative">
                <div className="bg-gray-100 p-8 h-full border border-gray-400 ">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    Visit our stone warehouse and choose your stone in person.
                    See full slabs, not tiny samples. Touch the surface. Compare
                    options side-by-side.
                  </p>
                  <p className="text-gray-600">
                    Once you've selected your material, we create a digital
                    template of your space (no messy cardboard anymore) and
                    fabricate your countertops off-site. Your home stays livable
                    and clean while we work.
                  </p>
                </div>
              </div>
              ...
              <div className="relative ">
                <div className="bg-gray-100 p-8 h-full border border-gray-400 ">
                  ...
                  <p className="text-gray-600 leading-relaxed mb-4">
                    ...
                    precision, seal if necessary, clean up completely, and hand
                    you a space that's ready to use immediately.
                  </p>
                  <p className="text-gray-600 ">
                    Most installations take just one day. You'll be making
            ...
            <div className="text-center mt-8">
              <p className="text-gray-600 leading-relaxed">
                {" "}
                No surprises. No excuses. No disappearing for weeks between
                steps.
              </p>
            </div>
          </div>
          ...
          <div className="container mx-auto px-4">
            <div className="flex flex-col md:flex-row items-center md:space-x-8">
              ...
              <div className="md:w-1/2 space-y-6">
                ...
                <p className="text-gray-600 leading-relaxed">
                  Every week you delay is another week of wiping down surfaces
                  that never look quite right. Another dinner party where you
                  catch yourself explaining, "We're planning to renovate
                  eventually." Another year of living in a kitchen that doesn't
                  match the home you've built.
                </p>
                <p className="text-gray-600 leading-relaxed">
                  Whether you need durable granite countertops in Northborough,
                  elegant marble countertops in Northborough, or modern quartz
                  surfaces installed by expert quartz installers near
                  Northborough, Stone Concepts transforms your vision into
                  reality.
                </p>
                <p className="text-gray-600 leading-relaxed">
